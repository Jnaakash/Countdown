...
const audioTracks = [{
        ...
        duration: "1:00",
        src: "music/song1.mp3" // Update this path
    },
    {
        title: "Celebration Time",
        artist: "Party Hits",
        duration: "1:00",
        src: "music/song2.mp3" // Update this path
    },
    {
        title: "Party Anthem",
        artist: "Birthday Beats",
        duration: "1:00",
        src: "music/song3.mp3" // Update this path
    }
];

// Gallery images for puzzle
const puzzleImages = [
    "https://silent-blush-x2w3b4czlx.edgeone.app/WhatsApp%20Image%202025-11-06%20at%2021.20.06_8f06b838.jpg",
    "https://comfortable-silver-heatueo05n.edgeone.app/WhatsApp%20Image%202025-11-06%20at%2021.20.07_289487a9.jpg",
    "https://native-moccasin-zrirknb0bp.edgeone.app/WhatsApp%20Image%202025-11-06%20at%2015.54.24_72def5a9.jpg"
];
...
function initializeEventListeners() {
    ...
    const playlist = [
  { title: 'Happy Birthday Song', artist: 'Birthday Collection', src: 'song1.mp3' }, // Placeholder MP3
  { title: 'Celebration Time', artist: 'Party People', src: 'song2.mp3' }, // Placeholder MP3
  { title: 'Party Anthem', artist: 'DJ Sparkle', src: 'song3.mp3' }  // Placeholder MP3
];
...
    // Set default birthday to November 16, 2025 at midnight (UTC)
    // महीने 0-indexed होते हैं (10 = November)
    const targetDate = new Date(Date.UTC(2025, 10, 16, 0, 0, 0));

    const birthdayInput = document.getElementById('birthdayDate');
    if (birthdayInput) {

            birthdayInput.value = targetDate.toISOString().slice(0, 16);
    }
...
function calculateTimeRemaining() {
    ...
    if (timeDiff <= 0) {
        ...
        if (messageDiv) {
            messageDiv.innerHTML = '<p class="birthday-celebration">🎉 Happy Birthday Aushii..🫀 in advanced...! 🎂</p>';
